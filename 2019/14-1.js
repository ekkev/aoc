...
const solve = input => {
    parseCosts(input);
    return getOreFor(1, 'FUEL');
}

module.exports = { getOreFor, parseCosts };
...
if (require.main === module) {
    ...
    console.log(solve(test), 165); // This one fails.. life is imperfect.
    ...
    console.log(solve(test), 2210736);
